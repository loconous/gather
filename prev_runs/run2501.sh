...
PREV_DATA_PATH="/home/exouser/24q3"
...
function bitbucket_discovery() {
  ...
  # Failed on timeout for connections
  # Last entries were for 2024-06-11 - rerun with:
  python3 bbRepos.py 2024-06-10 bitbucket$DT 2025-02-01 &> $DATA_PATH/bbRepos${DT}1.out &
}
